...
\def \TITLE{BÁO CÁO ĐỒ ÁN TỐT NGHIỆP}
\def \AUTHOR{HUY}
...
\renewcommand*{\acronymname}{DANH SÁCH THUẬT NGỮ}
\renewcommand*{\entryname}{Từ viết tắt}
\renewcommand*{\descriptionname}{Định nghĩa}
...
%\pagestyle{fancy} % Áp dụng header và footer%Kết luận và hướng phát triển}
